...
from lib.core.config import cfg, print_configs, merge_cfg_from_file


class MetricDepthModel(nn.Module):
    def __init__(self):
        super(MetricDepthModel, self).__init__()
        cfg_file_path = 'lib/configs/resnext101_32x4d_kitti_class'
        merge_cfg_from_file(cfg_file_path)
